...
<script type="text/javascript">
    ...
    //
    // locationMap.setMaxBounds(new L.LatLngBounds(southWest, northEast));
    //
    // locationMap.fitBounds(new L.LatLngBounds(southWest, northEast), {reset: true});
    ...
    locationMap.addLayer(pruneCluster);
