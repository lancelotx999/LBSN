    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('serviceContract.store') }}">
                    	@csrf
                    	@method('POST')
                    ...
                    @foreach ($contracts as $contract)
	                    <div id="{{ $contract->_id }}" class="media">
			                <div class="media-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <a href="{{ route('serviceContract.edit', $contract->_id) }}">
                                    ...
                                    <div class="col-sm-8">
        			                    <form method="POST" action="{{ route('serviceContract.destroy', $contract->_id) }}">
        			                    	@csrf
        									@method('DELETE')
